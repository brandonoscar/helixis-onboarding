  ...
  return (
    <Shell title="Terms of Service">
      ...
      <p>
        ...
        to start it, and it includes 150 credits. When it ends, you pick a plan or your
      ...
      <p>
        ...
        credits each month. <strong>Pro</strong> is $199 per seat per month and includes 400
        credits per seat each month. <strong>Scale</strong> is $500 per month for the whole
        account, with a pooled fair-use ceiling of 1,200 credits per month. One "credit" is
        one thing you ask Occupella that produces an answer; we don't charge a credit for a
        question that fails or returns nothing, and we don't count work Occupella does on its own, such as
      ...
      <p>
        ...
        does is on every plan; the plans differ in how many credits they include and in
